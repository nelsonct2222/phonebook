package com.aicheung.phonebook.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("phonebook");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("phonebook");
        ...
        config.getMapConfigs().put("com.aicheung.phonebook.domain.*", initializeDomainMapConfig(jHipsterProperties));
